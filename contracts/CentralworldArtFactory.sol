...
import "./CentralworldArtTradable.sol";

contract CentralworldArtFactory is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new CentralworldArtTradable contract
        ...
        returns (address)
    {
        ...
        CentralworldArtTradable nft = new CentralworldArtTradable(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
