...
import "./CentralworldArtTradablePrivate.sol";

contract CentralworldArtFactoryPrivate is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new CentralworldArtTradablePrivate contract
        ...
        returns (address)
    {
        ...
        CentralworldArtTradablePrivate nft = new CentralworldArtTradablePrivate(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
    ...
    /// @notice Method for registering existing CentralworldArtTradable contract
    ...
    /// @notice Method for disabling existing CentralworldArtTradable contract
    /// @param  tokenContractAddress Address of NFT contract
