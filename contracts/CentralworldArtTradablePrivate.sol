...
/**
 * @title CentralworldArtTradablePrivate
 * CentralworldArtTradablePrivate - ERC1155 contract that whitelists an operator address, 
 * has mint functionality, and supports useful standards from OpenZeppelin,
  like _exists(), name(), symbol(), and totalSupply()
 */
contract CentralworldArtTradablePrivate is
    ERC1155,
    ERC1155MintBurn,
    ERC1155Metadata,
    Ownable
{
    ...
    // Centralworld Marketplace contract
    address marketplace;
    // Centralworld Bundle Marketplace contract
    ...
    {
        // Whitelist Centralworld marketplace, bundle marketplace contracts for easy trading.
