 ...
 */
contract CentralworldAuction is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    using SafeMath for uint256;
    using AddressUpgradeable for address payable;
    using SafeERC20 for IERC20;

    /// @notice Event emitted only on construction. To be used by indexers
    event CentralworldAuctionContractDeployed();
        ...
        initializer
    {
        require(
            ...
            "CentralworldAuction: Invalid Platform Fee Recipient"
        );

        platformFeeRecipient = _platformFeeRecipient;
        emit CentralworldAuctionContractDeployed();
 ...
 */
        ...
        nonReentrant
    {
        ...
        ICentralworldMarketplace marketplace = ICentralworldMarketplace(
        ...
        emit AuctionResulted(
            ...
            winner,
            auction.payToken,
            ICentralworldMarketplace(addressRegistry.marketplace()).getPrice(
                auction.payToken
            ),
            winningBid
        );
