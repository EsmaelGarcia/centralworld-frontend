...
import "./CentralworldNFTTradablePrivate.sol";

contract CentralworldNFTFactoryPrivate is Ownable {
    /// @dev Events of the contract
    event ContractCreated(address creator, address nft);
    event ContractDisabled(address caller, address nft);

    /// @notice Centralworld auction contract address;
    address public auction;

    /// @notice Centralworld marketplace contract address;
    address public marketplace;

    /// @notice Centralworld bundle marketplace contract address;
    ...
    */
    ...
    /// @notice Method for deploy new CentralworldNFTTradable contract
        ...
        returns (address)
    {
        ...
        CentralworldNFTTradablePrivate nft = new CentralworldNFTTradablePrivate(
            _name,
            _symbol,
            auction,
            marketplace,
    ...
    /// @notice Method for registering existing CentralworldNFTTradable contract
    ...
    /// @notice Method for disabling existing CentralworldNFTTradable contract
    /// @param  tokenContractAddress Address of NFT contract
