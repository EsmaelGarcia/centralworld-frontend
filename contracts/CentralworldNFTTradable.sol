...
/**
 * @title CentralworldNFTTradable
 * CentralworldNFTTradable - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract CentralworldNFTTradable is ERC721, Ownable {
