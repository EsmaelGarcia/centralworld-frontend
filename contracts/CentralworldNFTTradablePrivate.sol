...
/**
 * @title CentralworldNFTTradablePrivate
 * CentralworldNFTTradablePrivate - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract CentralworldNFTTradablePrivate is ERC721, Ownable {
    ...
    */
    ...
    /**
     * Override isApprovedForAll to whitelist Centralworld contracts to enable gas-less listings.
     */
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        // Whitelist Centralworld auction, marketplace, bundle marketplace contracts for easy trading.
        if (
            auction == operator ||
    ...
    /**
     * Override _isApprovedOrOwner to whitelist Centralworld contracts to enable gas-less listings.
     */
