  ...
  const mintNFT = async () => {
    ...
    try {
      ...
      try {
        ...
        console.log('minted Token ID is ', mintedTkId);
        ...
        if(itemsavedata.data.status == "success"){
          showToast('success', 'New minted NFT item data saving success!')
          removeImage()
          setName('')
          setSymbol('')
          setDescription('')
        ...
        <div className={styles.panel}>
          ...
          <div className={styles.fee}>
            {fee !== null ? (
              <>
                <InfoIcon/>
                &nbsp;{fee} ETHs are charged to create a new NFT.
              </>
            ) : (
