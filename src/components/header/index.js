...
import logoSmallBlue from 'assets/imgs/centralworld_black_character.png';
                ...
                <div className={styles.resultlist}>
                  {collections.map((collection, idx) => (
                    <div
                      ...
                      onClick={() =>
                        handleSelectCollection(collection.nftAddress)
                      }
                    >
                      <img
        ...
        <div className={styles.left}>
          ...
          <div className={cx(styles.sidebar, collapsed && styles.collapsed)}>
            <div className={styles.sidebarHeader}>
              ...
              <label htmlFor="collapsible" className={styles.lbltoggle}>
                <img
                  src={iconCollapse}
