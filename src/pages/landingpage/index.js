...
import logo from 'assets/imgs/centralworld_white_character.png';
import fantomLogo from 'assets/svgs/Ethereum.svg';
...
const cards = [
  ...
  },
  {
    ...
    title: 'Super Fast',
    description:
      'Since CentralWorld runs on the Ethereum Network, transactions are usually confirmed within 1-2 seconds.',
    path: '/',
  },
  {
    icon: card3,
  ...
  },
  {
    ...
    description:
      'Trade NFTs via auction or direct offer without any fees taken by CentralWorld.',
    path: '/explore',
  },
];
      ...
      <div className={styles.body}>
        <div className={styles.main}>
          <div className={styles.mainLeft}>
            ...
            >{`Trade without platform fees on CentralWorld`}</div>
            <div className={styles.subtitle}>
              CentralWorld is an NFT marketplace built on Ethereum. Create and trade
        ...
        <div className={styles.about}>
          <div className={styles.aboutInner}>
            <div className={styles.aboutTitle}>Why CentralWorld</div>
        ...
        <div className={styles.footer}>
          ...
          <a
            ...
            noreferrer"
          >
            <img src={fantomLogo} alt="fantom-logo" className={styles.etherlogo} />
          </a>
        </div>
      </div>
    </div>
